		...
		<div class="section">
			<div class="row">
				<p class="center-align" id="register-text">
					<strong>Recover Your Anakost Account</strong><br>
				</p>
				<form action="<?php echo $form_forgot; ?>" method="post" class="col s12 m6 offset-m3" id="formValidate">
					<div class="row">
						...
						<div class="input-field col s12 m12">
							<button class="btn waves-effect waves-light col s12 m12 float-right" type="submit" name="submit">Reset</button>
						</div>
						<div class="input-field col s12 m12">
							<p class="center-align">After submit, you will receive an email containing link to reset your password. Those link will expired in 1 x 24 hours.</p>
						</div>
					</div>
				</form>
			</div>
